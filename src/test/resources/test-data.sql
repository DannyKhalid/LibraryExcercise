...
INSERT INTO librarian (id, name, address, email, phone_number) VALUES (1, 'Emily Turner', '221B Baker Street', 'emilyt@example.com', 0555667788);
INSERT INTO librarian (id, name, address, email, phone_number) VALUES (2, 'David Green', '48 Sunshine Ave', 'davidg@example.com', 0555778899);
INSERT INTO librarian (id, name, address, email, phone_number) VALUES (3, 'Sophia Martinez', '350 River Road', 'sophiam@example.com', 0555889900);
INSERT INTO librarian (id, name, address, email, phone_number) VALUES (4, 'James Wilson', '67 Mountain View', 'jamesw@example.com', 0555990011);
INSERT INTO librarian (id, name, address, email, phone_number) VALUES (5, 'Isabella Brown', '1234 Spring Lane', 'isabellab@example.com', 0555101122);
INSERT INTO librarian (id, name, address, email, phone_number) VALUES (6, 'Robert Johnson', '789 Ocean Blvd', 'robertj@example.com', 0555212233);
